...
$route['visitas/administrarVisitas'] = 'visita/administrarVisitas';
$route['visitas/administrarVisitas/crear'] = 'visita/crear';
$route['visitas/administrarVisitas/eliminar/(:any)'] = 'visita/eliminar/$1';
$route['visitas/administrarVisitas/modificar/(:any)'] = 'visita/modificar/$1';
$route['visitas/administrarVisitas/modificar/cargar/(:any)'] = 'visita/cargar/$1';
$route['examenes/administrarExamenes/(:any)'] = 'examen/administrarExamenes/$1';
$route['examenes/administrarExamenes/eliminar/(:any)/(:any)'] = 'examen/eliminar/$1/$2';
$route['examenes/administrarExamenes/crear/(:any)'] = 'examen/crear/$1';
$route['examenes/administrarExamenes/modificar/(:any)'] = 'examen/cargar/$1';
$route['examenes/administrarExamenes/modificar/(:any)/(:any)'] = 'examen/modificar/$1/$2';
//$route['404_override'] = '';
//$route['translate_uri_dashes'] = FALSE;
